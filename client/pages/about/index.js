    ...
    <div className="about-main">
      ...
      <div className="about-container">
        ...
        <div className="about-right-layer">
          <h2 className="about-subtitle">BIO</h2>
          <div className="about-description">
            <p>
              Basé à Marseille, je suis un développeur web fullstack Javascript
              créatif passionné par le design et les animations.
              <br />
              Étudiant Epitech en première année de Master dès le 12 Septembre
              2022, je suis à la recherche d'une entreprise accueillant un
              alternant.
            </p>
          </div>
          <h2 className="about-subtitle">TECHNOS</h2>
          ...
          <div className="about-social">
            <div className="about-link">
              <Link href="mailto: david.chmarzynski@gmail.com">
                <a className="about-email" target="_blank">
                  EMAIL
                </a>
              </Link>
              <ArrowRightOutlined />
            ...
            <div className="about-link">
              <Link href="https://github.com/david-chmarzynski">
                <a className="about-github" target="_blank">
                  GITHUB
                </a>
              </Link>
              <ArrowRightOutlined />
            ...
            <div className="about-link">
              <Link href="https://www.linkedin.com/in/david-chmarzynski-3bab78190/">
                <a className="about-linkedin" target="_blank">
                  LINKEDIN
                </a>
              </Link>
              <ArrowRightOutlined />
          ...
          <h2 className="about-subtitle">RECRUTEZ-MOI</h2>
          <div className="about-hire">
            <div className="about-epitech">E</div>
            <div className="about-curriculum">CV</div>
          </div>
        </div>
      </div>
    </div>
